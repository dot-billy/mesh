...
enum AppleManagedConfigurationReader {
  static let containerKey = "com.apple.configuration.managed"
  ...
  static func read(defaults: UserDefaults = .standard) throws -> [String: Any]? {
    guard let raw = defaults.dictionary(forKey: containerKey) else {
      return nil
    }
